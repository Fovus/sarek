process SENTIEON_DEDUP {
    ...
    sentieon driver ${args} -t \${FovusOptVcpu} ${input_list} -r ${fasta} --algo LocusCollector ${args2} --fun score_info ${prefix_basename}.score
    sentieon driver ${args3} -t \${FovusOptVcpu} ${input_list} -r ${fasta} --algo Dedup ${args4} --score_info ${prefix_basename}.score --metrics ${metrics} ${prefix}
