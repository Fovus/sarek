...
workflow BAM_VARIANT_CALLING_DEEPVARIANT {
    ...
    //DEEPVARIANT_RUNDEEPVARIANT(cram, fasta, fasta_fai, [ [ id:'null' ], [] ])
    ...
    //vcf = DEEPVARIANT_RUNDEEPVARIANT.out.vcf
    //tbi = DEEPVARIANT_RUNDEEPVARIANT.out.vcf_index
    //tbi = DEEPVARIANT_RUNDEEPVARIANT.out.vcf_tbi
